//NOTE: This is the javascript from https://s3.tradingview.com/tv.js but I have it here to let the extension
// run properly. This code was not created by Apache Extensions.
// For more information about this widget go to https://www.tradingview.com/widget/advanced-chart/
"use strict";
(function () {
    ...
    TradingView.WidgetAbstract.prototype = {
        fixSize: function (size) {
            ...
            return '<div id="' + this.id + '-wrapper" style="' + "position: relative;" + "box-sizing: content-box;" + "width: " + width + ";" + "height: " + height + ";" + "margin: 0 auto !important;" + "padding: 0 !important;" + "font-family:Arial,sans-serif;" + "overflow: hidden;" + "border-radius: 3px;" + '">' + '<div style="' + "width: " + width + ";" + "height: " + height + ";" + "background: " + widgetBgColor + ";" + "padding: 0 !important;" + '">' + widgetCode + "</div>" + (logoCode || "") + "</div>"
    ...
    TradingView.showSignIn = function (options, callback) {
        TradingView.dependenciesManager.depends(["/static/bundles/spinner.js"], "authWidget", function () {
            ...
            (new window.Spinner).setStyle({color: "#00A2E2", opacity: "0"}).spin(spinnerContainer);
